...
print(f"module :{x.o}")
x.exp(9,3)
print(f"Exponents :{x.r}")
x.floor(45487,125)
print(f"Floor Divison :{x.u}")
...
class name(main):
	def __init__(self,a,b,d,e):
		...
		self.f=d**e
	def second(self):
		print("when you will work hard then you will get reward after the result")
class prince(name):
	def __init__(self,a,b,d,e,g,h):
		super().__init__(a,b,d,e)
		self.g=g
		...
		self.i=g*h+g
	def third(self):
		print("Be positive and stay positive then you never watchichg in your back ")
x=prince(10,8,6,3,9,12)
print(x.c)
print(x.f)
print(x.i)
x.first()
...
class dup:
	def __init__(self,d,e):
		...
		self.f=d**e
	def second(self):
		print("python is an interpated language")
class prince(main,dup):
	def __init__(self,a,b,d,e,g,h):
		main.__init__(self,a,b)
		dup.__init__(self,d,e)
		self.g=g
		self.h=h
		self.i=g+h
	def third(self):
		print("python was invented in 1998")
x=prince(12,10,45,3,25,89)
print(x.c)
print(x.f)
print(x.i)
x.first()
...
class A:
	def __init__(self,a,b):
		...
		self.c=a//b
	def frist(self):
		print("file handling is an important cheptor for web program")
class B:
	def chhotu(self,d,e):
		self.d=d
		self.e=e
		self.f=d**e
	def second(self):
		print("currentlly i am purcuing data science")
class prince(A,B):
	def __init__(self,a,b,d,e,g,h):
		super().__init__(a,b)
		super(). chhotu(d,e)
...
class prince(main):
	def __init__(self):
		print("today is a good day \n we better because it has raining")
class kumar(main):
	def __init__(self):
		print("Advance Diploma in computer application is called ADCA")
x=prince()
y=kumar()
...
class child(per_1,per_2):
	def __init__(self,a,b,d,e,g,h):
		per_1.__init__(self,a,b)
		per_2.__init__(self,d,e)
		self.g=g
		self.h=h
		self.k=g-h
...
class pappu:
	...
	def kr1(self):
		print("maa is everything for me")
...
class maa(prince,pappu,vicky):
	def __init__(self):
		print("i have three son")

	def __init__(self):
		print("my son  and doughter every thing for me")
...
'''class prince:
	...
	#def second(self):
		print(f"currently i work in {self.company}")

x=prince("prince kumar",54000,"prince pvt ltd")
x.first()'''
#x.second()
'''
class c1:
	def first(self):
		mydict={"name": "prince","age":45,"height":56}
		for i in mydict:
			print(i)
